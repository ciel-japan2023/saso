...
for (let y=0; y<8; y++){
	for (let x=0; x<11; x++){
		if (invLayout1[y][x] == 0){
			...
			invElm1 += x * invDotW + "px " + y * invDotH +"px blueviolet,";
		}
		if (invLayout2[y][x] == 0){
			invElm2 += x * invDotW + "px " + y * invDotH +"px black,";
		}
		else {
			invElm2 += x * invDotW + "px " + y * invDotH +"px blueviolet,";
		}
		if (invLayout3[y][x] == 0){
			invElm3 += x * invDotW + "px " + y * invDotH +"px black,";
		}
		else {
			invElm3 += x * invDotW + "px " + y * invDotH +"px blueviolet,";
		}
	}
}
...
$("#inv_bullet").css({
	...
	"box-shadow": invDotW + "px " + invDotH +"px lime"
});
